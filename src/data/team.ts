export const TEAM = [
  {
    ...
    bio: "Todd has held leadership positions at all seats around the table: investor, banker, entrepreneur, director, and corporate executive. His investment experience spans aerospace & defense, healthcare, technology, industrial manufacturing, and financial services.     Earlier in his career, Todd was a founding partner of Candlewood Capital, a hedge fund management company. More recently he served as interim CEO & CFO of Radiance Therapeutics and currently is a director of ClearSign Technologies (CLIR – NASDAQ).",
  ...
  },
  {
    ...
    title: "Director of Healthcare Investments",
