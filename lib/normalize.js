 ...
 * Defaults for pipeline / dealstage / hubspot_owner_id match exported n8n workflow when env unset.
...
export function normalizeLeadPayload(raw) {
  ...
  const hubspot_owner_id = process.env.HUBSPOT_DEAL_OWNER_ID || "84540706";
