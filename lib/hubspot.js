 ...
 * Associations use v3 batch + string types (deal_to_contact, etc.) like n8n.
 */
...
/**
 * n8n-compatible v3 batch associations (type string, capital object names in path).
 * @param {string} token
 * @param {string} path e.g. /crm/v3/associations/Contacts/Companies/batch/create
 * @param {string} fromId
 * @param {string} toId
 * @param {string} type e.g. contact_to_company, deal_to_contact, deal_to_company
 */
export async function associateV3Batch(token, path, fromId, toId, type) {
  await hubspotRequest(token, "POST", path, {
    inputs: [
      {
...
/** Paths match n8n HTTP Request nodes */
export const ASSOCIATION_PATHS = {
  contactCompany: "/crm/v3/associations/Contacts/Companies/batch/create",
  dealContact: "/crm/v3/associations/Deals/Contacts/batch/create",
  dealCompany: "/crm/v3/associations/Deals/Companies/batch/create",
};
